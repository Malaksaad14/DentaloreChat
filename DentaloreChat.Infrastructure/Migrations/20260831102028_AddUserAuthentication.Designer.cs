...
namespace DentaloreChat.Server.Migrations
{
    ...
    [Migration("20260831102028_AddUserAuthentication")]
            ...
            modelBuilder.Entity("DentaloreChat.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2026, 8, 31, 10, 10, 27, 524, DateTimeKind.Utc).AddTicks(4768)
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2026, 8, 31, 10, 15, 27, 524, DateTimeKind.Utc).AddTicks(4798)
                        },
                        new
                        {
                            ...
                            ConversationId = new Guid("c1010101-1111-1111-1111-111111111111"),
                            SenderId = new Guid("a1111111-1111-1111-1111-111111111111"),
                            Timestamp = new DateTime(2026, 8, 31, 9, 55, 27, 524, DateTimeKind.Utc).AddTicks(4810)
                        },
                        new
                        {
                            ...
                            ConversationId = new Guid("c1010101-1111-1111-1111-111111111111"),
                            SenderId = new Guid("a2222222-2222-2222-2222-222222222222"),
                            Timestamp = new DateTime(2026, 8, 31, 10, 0, 27, 524, DateTimeKind.Utc).AddTicks(4815)
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2026, 8, 31, 10, 18, 27, 524, DateTimeKind.Utc).AddTicks(4821)
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2026, 8, 31, 10, 10, 27, 524, DateTimeKind.Utc).AddTicks(4827)
                        });
                });
            ...
            modelBuilder.Entity("DentaloreChat.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClinicId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Email = "hana@clinic.com",
                            Name = "Dr. Hana",
                            PasswordHash = "$2a$11$PinGI0C0inHXuOSlxojh/eghTbvVRMbJL3cHP4L5t7.pGGmWEVRty"
                        },
                        new
                        {
                            ...
                            Name = "Dr. Ahmed",
                            PasswordHash = "$2a$11$Vx3Pn3/2GtEpmoW0p4Ab3.k6DagbYEJUF/ZhSAG2PCXG5ixYM64AK"
                        },
                        new
                        {
                            ...
                            Name = "Dr. Sara",
                            PasswordHash = "$2a$11$SNpH21GAZAmYWW3YM.wYYOrxBdkGni6zaaOkj288EwNvUaU5khQWK"
                        },
                        new
                        {
                            ...
                            Name = "Dr. Omar",
                            PasswordHash = "$2a$11$0BQW0LsGFVGQU3YhDuzQSOB/cd5aJbRFjmrUXN1j1dbIf/xTm0VvK"
                        });
                });
